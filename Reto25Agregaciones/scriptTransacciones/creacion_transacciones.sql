...
--Consulta 
select tr.codigo,tr.numero_cuenta,tr.monto,tr.tipo,tr.fecha,tr.hora,ba.codigo_banco,ba.codigo_transaccion,ba.detalle from
transacciones tr,banco ba
where
tr.banco = ba.codigo_banco
and tr.tipo = 'C' and (numero_cuenta between '22001' and '22004')

--Subconsulta
select tr.codigo,tr.numero_cuenta,tr.monto,tr.tipo,tr.fecha,tr.hora from
transacciones tr, banco ba
where
tr.banco = ba.codigo_banco
and tr.codigo = 1
...
as monto_promedio from transacciones group by numero_cuenta