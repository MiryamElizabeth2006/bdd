...
insert into prestamo(cedula,monto,fecha_prestamo,hora_prestamo,garante)
values('6599564656',450,'02/06/2022','13:30','Sean');
...
insert into personas (cedula,nombre,apellido,fecha_nacimiento,prestamo)
values ('1755646732','Elizabeth','Nono','05/06/2000','1784526914');

insert into personas (cedula,nombre,apellido,fecha_nacimiento,prestamo)
values ('1755646734','Pamela','León','15/07/2001','0603528742');

insert into personas (cedula,nombre,apellido,numero_hijos,fecha_nacimiento,prestamo)
values ('1755646735','Luisa','Lian',2,'12/02/1995','1345789623');
...
insert into personas (cedula,nombre,apellido,fecha_nacimiento,prestamo)
values ('1654654515','Elizabeth','Fernandez','14/02/2000','6565662622');

insert into personas (cedula,nombre,apellido,estatura,fecha_nacimiento,prestamo)
values ('4565665656','Rosa','León',1.58,'15/12/2001','9989556566');

insert into personas (cedula,nombre,apellido,numero_hijos,fecha_nacimiento,prestamo)
values ('1755614735','Rosa','Lian',2,'18/05/2002','5646545645');